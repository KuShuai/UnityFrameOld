...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(UnityEngine.Playables.IPlayableAsset), UnityEnginePlayablesIPlayableAssetWrap.__Register);
        ...
        static void wrapInit2(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(XLua.Cast.IEnumerator), XLuaCastIEnumeratorWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(UpdateErrorCode), UpdateErrorCodeWrap.__Register);
