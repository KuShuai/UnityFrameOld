...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePlayablesIPlayableAssetWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.Playables.IPlayableAsset);
        ...
        {
            return LuaAPI.luaL_error(L, "UnityEngine.Playables.IPlayableAsset does not have a constructor!");
        }
        ...
        static int _m_CreatePlayable(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Playables.IPlayableAsset gen_to_be_invoked = (UnityEngine.Playables.IPlayableAsset)translator.FastGetCSObj(L, 1);
