...
#pragma warning restore 414
    ...
    public partial class ObjectTranslator
	{
        ...
        public bool TryDelayWrapLoader(RealStatePtr L, Type type)
        {
            ...
            {
#if UNITY_EDITOR
                //bool lua_use_reflection = UnityEditor.EditorPrefs.GetBool("lua_use_reflection", false);
                //if (!UnityEngine.Application.isPlaying || lua_use_reflection)
#endif
                {
        ...
        public void ReleaseAllDelegateBridge()
        {
            ...
            {
                var value = delegate_bridges[keys[i]];
                if (value.IsAlive)
                {
                    var delegate_obj = (LuaBase)value.Target;
                    delegate_obj.Dispose();
                }
            }
        }
